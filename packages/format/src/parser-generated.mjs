...
function peg$parse(input, options) {
  ...
  var peg$f39 = function(body) {
    return ['export ', ...body]
  };
  var peg$f40 = function(a, list, b, type) {
      return [
        '/* function */', a,
  ...
  var peg$f45 = function() { return 'readonly '};
  var peg$currPos = 0;
  var peg$savedPos = 0;
  ...
  function peg$parseExpandIdentifier() {
    var s0, s1, s2, s3;
