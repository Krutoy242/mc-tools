...
function peg$parse(input, options) {
  ...
  var peg$c16 = "{";
  var peg$c17 = "mixin";
  var peg$c18 = "no_fix_recipe_book";
  var peg$c19 = "debug";
  var peg$c20 = "loader";
  var peg$c21 = "profile";
  var peg$c22 = "norun";
  var peg$c23 = "reloadable";
  var peg$c24 = "ikwid";
  var peg$c25 = "zslint";
  var peg$c26 = "suppress";
  var peg$c27 = "priority";
  var peg$c28 = "modloaded";
  var peg$c29 = "nowarn";
  var peg$c30 = "notreloadable";
  var peg$c31 = "ignoreBracketErrors";
  var peg$c32 = "hardfail";
  var peg$c33 = "onside";
  var peg$c34 = "sideonly";
  var peg$c35 = "disable_search_tree";
  var peg$c36 = "null";
  var peg$c37 = "false";
  var peg$c38 = "true";
  var peg$c39 = "as";
  ...
  var peg$c106 = "zenClass";
  var peg$c107 = "extends";
  var peg$c108 = "zenConstructor";
  ...
  var peg$e22 = peg$literalExpectation("mixin", false);
  var peg$e23 = peg$literalExpectation("no_fix_recipe_book", false);
  var peg$e24 = peg$literalExpectation("debug", false);
  var peg$e25 = peg$literalExpectation("loader", false);
  var peg$e26 = peg$literalExpectation("profile", false);
  var peg$e27 = peg$literalExpectation("norun", false);
  var peg$e28 = peg$literalExpectation("reloadable", false);
  var peg$e29 = peg$literalExpectation("ikwid", false);
  var peg$e30 = peg$literalExpectation("zslint", false);
  var peg$e31 = peg$literalExpectation("suppress", false);
  var peg$e32 = peg$literalExpectation("priority", false);
  var peg$e33 = peg$literalExpectation("modloaded", false);
  var peg$e34 = peg$literalExpectation("nowarn", false);
  var peg$e35 = peg$literalExpectation("notreloadable", false);
  var peg$e36 = peg$literalExpectation("ignoreBracketErrors", false);
  var peg$e37 = peg$literalExpectation("hardfail", false);
  var peg$e38 = peg$literalExpectation("onside", false);
  var peg$e39 = peg$literalExpectation("sideonly", false);
  var peg$e40 = peg$literalExpectation("disable_search_tree", false);
  ...
  var peg$e46 = peg$literalExpectation("as", false);
  ...
  var peg$e53 = peg$classExpectation(["f", "d", "b", "s", "l"], false, true);
  ...
  var peg$e59 = peg$literalExpectation("0x", true);
  ...
  var peg$e72 = peg$literalExpectation("if", false);
  var peg$e73 = peg$literalExpectation("else", false);
  var peg$e74 = peg$literalExpectation("for", false);
  var peg$e75 = peg$literalExpectation("in", false);
  ...
  var peg$e80 = peg$literalExpectation("var", false);
  var peg$e81 = peg$literalExpectation("val", false);
  var peg$e82 = peg$literalExpectation("static", false);
  var peg$e83 = peg$literalExpectation("global", false);
  var peg$e84 = peg$otherExpectation("Assignment");
  ...
  var peg$e104 = peg$otherExpectation("operator");
  var peg$e105 = peg$literalExpectation("??", false);
  var peg$e106 = peg$literalExpectation("has", false);
  ...
  var peg$e120 = peg$otherExpectation("expand");
  var peg$e121 = peg$literalExpectation("$expand", false);
  var peg$e122 = peg$otherExpectation("function");
  var peg$e123 = peg$literalExpectation("function", false);
  var peg$e124 = peg$literalExpectation("zenClass", false);
  ...
  var peg$f6 = function(head) {
    return [`@mixin`, head ? "." : "", head]
  };
  var peg$f7 = function(body) { return body };
  var peg$f8 = function(head, body) { return [head, body] };
  var peg$f9 = function(tail) {
  ...
  var peg$f11 = function(call, casts) {
    // Wrap each cast in `__as<Type>(...)`. The function call is opaque to
    // ESLint (no `as` keyword survives in the TS), so rules like
    // `ts/no-unnecessary-type-assertion` cannot strip it. Chained casts
    // become nested calls, preserving left-to-right ZS semantics:
    //   `x as A as B` → `__as<B>(__as<A>(x))`
    let acc = flat(call)
    for (const type of casts) {
      acc = `__as<${flat(type).trim()}>(${acc})`
    }
    return acc
  };
  ...
  var peg$f13 = function(type) { return type };
  var peg$f14 = function(types) {
  	return types.map(o=>flat(o).replace(/as/, ":/* as */"))
  };
  var peg$f15 = function(head, name) { return name };
  var peg$f16 = function(head, tail) {
    return tail ? ['__$', tail, '<', head, '>'] : [head]
  };
  var peg$f17 = function(body) {
  	return ['Array<',...body, ">"]
  };
  var peg$f18 = function(num, type) {
    if(!type) return num
  ...
  var peg$f19 = function(a, head, body) {
    return [a, '(', head, ')', body]
  };
  var peg$f20 = function(pre, head, body, tail) {
    return [pre, '(', head, ')', body, tail]
  };
  var peg$f21 = function(vars, from, to, body) {
    return ['for (let ', vars, ' = ', from, ';', vars, ' < ', to, ';', vars, '++) ', body]
  };
  var peg$f22 = function(vars, from, body) {
    return ['for (const [', vars, '] of (', from, ').entries()/**/)', body]
  };
  var peg$f23 = function(vars, from, body) {
    return ['for (const ', vars, ' of ', from, ')', body]
  };
  var peg$f24 = function(ws, expr) {
    const wsFlat = flat(ws)
    return wsFlat.includes('\n') ? ['return __return(', ws, expr, ')'] : ['return', ws, expr]
  };
  var peg$f25 = function(head, classpath, rename) {
  ...
  var peg$f26 = function() {return '/* $ */let'};
  var peg$f27 = function() {return '/* $ */const'};
  var peg$f28 = function() {return '/* static */const'};
  var peg$f29 = function() {return '/* global */const'};
  var peg$f30 = function() { return '/* ~ */+=' };
  var peg$f31 = function(body) {
    return ["$`", body, "`"]
  };
  ...
  var peg$f33 = function(s) {
    // ZS keywords used as object keys (`'function': v`) would be unquoted by
    // ESLint's `quote-props: consistent-as-needed` (reserved words are valid
    // bare property names in JS). The upstream ZS runtime then re-tokenises
    // a bare `function:` as the start of a declaration. Swap the StringLiteral
    // for a synthetic identifier `_$_kw_<name>` that ESLint passes through;
    // the QUOTED_KEYWORD_KEY revert rule restores the quotes. Keep the list
    // here in sync with `ZS_KEYWORDS` in `markers.ts`.
    const text = flat(s)
    const inner = text.slice(1, -1)
    const ZS_KW = ('as break continue do else extends false for frigginClass'
      + ' frigginConstructor frigginGetter frigginSetter function global has'
      + ' if import in instanceof null return static to true val var version'
      + ' while zenClass zenConstructor zenGetter zenSetter').split(' ')
    return ZS_KW.includes(inner) ? `_$_kw_${inner}` : text
  };
  var peg$f34 = function(minus, body) {
  ...
  var peg$f35 = function(start, end) {
          return ['.slice(', start, ', ', end, ')']
        };
  var peg$f36 = function() { return '/* ~ */ +' };
  var peg$f37 = function() { return '/* has */in' };
  var peg$f38 = function(def) {
    return ['/* $expand */ export function ', def]
  };
  var peg$f39 = function(className, methodName, params, type, ws1, body, ws2) {
      return [
        methodName,
        '(this: ', className,
        params ? [', ', params] : '',
  ...
  var peg$f41 = function(a, list, b, type) {
      return [
        '/* function */', a,
  ...
  var peg$f44 = function(body) {
    return ['/* class */', body]
  };
  var peg$f45 = function() {};
  var peg$f46 = function() { return 'readonly '};
  var peg$currPos = 0;
  var peg$savedPos = 0;
                      ...
                      if (s0 === peg$FAILED) {
                        ...
                        if (s0 === peg$FAILED) {
                          ...
                          if (s0 === peg$FAILED) {
                            ...
                            if (s0 === peg$FAILED) {
                              if (input.substr(peg$currPos, 19) === peg$c31) {
                                s0 = peg$c31;
                                peg$currPos += 19;
                              } else {
                                s0 = peg$FAILED;
  ...
  function peg$parseCastChain() {
    ...
    s0 = peg$currPos;
    s1 = peg$parseCastSingle();
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$currPos;
      s4 = peg$parse__();
      if (s4 !== peg$FAILED) {
        s5 = peg$parseCastSingle();
        if (s5 !== peg$FAILED) {
          s4 = [s4, s5];
          s3 = s4;
        } else {
  ...
  function peg$parseExpandDefinition() {
          ...
          if (s5 !== peg$FAILED) {
            ...
            if (s8 !== peg$FAILED) {
              ...
              if (s11 !== peg$FAILED) {
                ...
                if (s15 !== peg$FAILED) {
                  peg$savedPos = s0;
                  s0 = peg$f39(s1, s3, s7, s9, s12, s13, s14);
                } else {
                  peg$currPos = s0;
                  s0 = peg$FAILED;
                }
