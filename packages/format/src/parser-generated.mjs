...
function peg$parse(input, options) {
  ...
  var peg$f31 = function(minus, body) {
  ...
  var peg$f33 = function() { return '/* has */in' };
  var peg$f34 = function(body) {
    return ['export ', ...body]
  };
  var peg$f35 = function(a, list, b, type) {
      return [
        '/* function */', a,
  ...
  var peg$f40 = function() { return 'readonly '};
  var peg$currPos = 0;
  var peg$savedPos = 0;
